...
if not st.session_state.gate_passed:
    ...
    with col1:
        ...
        input_3 = st.text_area("🎯 3. المشكلة والفجوة في السوق:", height=100, placeholder="ما هي المشكلة التي يحلها؟ وما الذي يميّزه عن الساعات الذكية أو الحلول البديلة الحالية Ley...")
    with col2:
    ...
    if st.button("بدء الفحص الاستراتيجي 🚀"):
        if input_1.strip() and input_2.strip() and input_3.strip():
            with st.spinner("جاري تحليل البيانات والصور وتطبيق بروتوكول الريادة الابتكارية..."):
                ...
                [===LEVEL3===]
                ### 🛣️ ثالثاً: الجدوى الاقتصادية وخارطة الريادة الابتكارية
                1. نموذج فرض الريادة وحماية الهندسة العكسية.
                ...
                [===SOVEREIGNTY===]
                ### 💡 خامساً: توصية الريادة الابتكارية المطلقة
    ...
    # 🔑 سطر التبويبات سليم ومحاذاة تماماً مع الكتل الشرطية
